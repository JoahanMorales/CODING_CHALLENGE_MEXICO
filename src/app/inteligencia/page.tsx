...
const innovations = [
  ...
  ["Isotónica en competencia + walk-forward + transferencia", "La calibración isotónica (PAV, Zadrozny & Elkan 2002) compite contra Platt y solo se adjunta la ganadora del fold de evaluación intocado — en los smoke tests cada una ganó una vez, la competencia es real. --split temporal hace la validación walk-forward (entrena < calibra < evalúa en orden cronológico estricto, cero fuga del futuro) y --evalTape liquida un tape de otra sesión con el modelo congelado. Cada win-rate del barrido lleva su cota inferior Wilson IC95."],
  ["Features temporales v3 — el modelo ve el tiempo", "Los 19 features eran fotos de una sola ronda, pero el OFI se define sobre intervalos (Cont-Kukanov-Stoikov 2014). observeBook() mantiene una historia rodante por venue (throttle 400ms, ventana ~8s) y deriva 5 features nuevos: momentum del mid por venue, delta de imbalance por venue y volatilidad realizada. Una dislocación que aparece CON momentum hacia la convergencia muere rápido; una que aparece mientras los libros se separan persiste — una foto instantánea no distingue esos dos casos."]
];
    ...
    <main className="min-h-screen text-zinc-900">
      ...
      <section className="border-y border-sky-100 px-5 py-12">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-2 text-3xl font-black text-zinc-950">Veintiún mejoras sobre el modelo base</h2>
