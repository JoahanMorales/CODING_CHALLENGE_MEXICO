      ...
      <section className="px-5 py-12 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
          ...
          <div className="fade-up relative min-h-[440px] overflow-hidden rounded-3xl border border-white/10 bg-[#070b16] shadow-2xl shadow-sky-950/30 sm:min-h-[520px]">
            ...
            />
            <NeuralHeroMount />
            {/* Top overline: names what the network IS, so the visual reads as the
                decision pipeline it models rather than abstract eye-candy. */}
            ...
            {/* Bottom legend: one colour-coded label per glowing layer, so each column
                is named. Reflows 3-up on mobile (never clipped) and 6-up from sm. */}
