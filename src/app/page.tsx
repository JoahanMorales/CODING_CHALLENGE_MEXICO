        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-xl text-lg font-semibold leading-8 text-zinc-600">
              Inteligencia institucional para arbitraje BTC. Siete mercados, una capa cuantitativa explicable y una terminal que distingue señal de ruido.
            </p>
            ...
            <div className="mt-10 grid max-w-xl grid-cols-3 gap-3">
              ...
              <HeroMetric label="Rutas stat arb" value="21" />
          ...
          <div className="relative min-h-[380px] overflow-hidden rounded-3xl border border-sky-100 bg-white shadow-xl shadow-sky-100/70">
            <div className="absolute inset-x-0 top-0 flex items-center justify-between border-b border-sky-100 bg-sky-50/70 px-5 py-4">
              ...
              <span className="font-mono text-[10px] font-black uppercase text-emerald-700">signal survival map</span>
            </div>
            <div className="absolute inset-x-0 bottom-0 grid grid-cols-3 gap-px border-t border-sky-100 bg-sky-100">
              ...
              <CanvasMetric label="Survival" value="72%" />
              <CanvasMetric label="Queue" value="score" />
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-3 grid gap-5 lg:grid-cols-3">
            <FeatureBlock number="01" title="Primero sobrevive costos">
              Fees, slippage, latencia e impacto se descuentan antes de considerar una señal ejecutable.
            </FeatureBlock>
            <FeatureBlock number="02" title="Aprende incluso al rechazar">
              Shadow Learning evalúa markouts y calibra AET con señales que una estrategia greedy habría perseguido.
            </FeatureBlock>
            <FeatureBlock number="03" title="Prueba sin fingir dinero real">
              Paper P&L y validación firmada TEST_ORDER viven en carriles visuales distintos y auditables.
            </FeatureBlock>
          </div>
        </div>
      </section>
